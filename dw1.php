...
<html>
<head>
<title>Shoppe Bootstrap Website Template | Home :: w3layouts</title>
...
<div class="main">
    ...
    <div id="fwslider">
        <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
                    <img src="web/images/slider1.jpg" class="img-responsive" alt=""/>
                <!-- /Slide image -->
            </div>
            <!-- /Duplicate to create more slides -->
            <div class="slide">
                <img src="web/images/slider2.jpg" class="img-responsive" alt=""/>
            </div>
            <div class="slide">
                <img src="web/images/slider3.jpg" class="img-responsive" alt=""/>
            </div>
            <!--/slide -->
        </div>
	...
	<!-- end  slider -->
		...
		<div class="grid_list">
			<a href="details.html"> 
				<div class="grid_img"> 
					<img src="web/images/grid_pic1.jpg" class="img-responsive" alt=""/>
				</div>
		...
		<div class="grid_list">
			<a href="details.html"> 
				...
				<div class="grid_img last"> 
					<img src="web/images/grid_pic2.jpg" class="img-responsive" alt=""/>
				</div>
				<div class="clearfix"></div>
			  </a>
			</div>				
		<div class="grid_list"> 
			<a href="details.html">
				<div class="grid_img"> 
					<img src="web/images/grid_pic3.jpg" class="img-responsive" alt=""/>
				</div>
				<div class="grid_text left">
	...
	<div class="content">
		...
		<div class="row grids">
			<div class="col-md-3 grid1">
			  <a href="details.html">
				<img src="web/images/pic1.jpg" class="img-responsive" alt=""/>
				<div class="look">			
					<h4>get scraves</h4>
					<p>read more</p>
				</div></a>
			...
			<div class="col-md-3 grid1">
			  <a href="details.html">
				<img src="web/images/pic2.jpg" class="img-responsive" alt=""/>
				<div class="look">			
					<h4>Fashion Tips</h4>
					<p>read more</p>
				</div></a>
			...
			<div class="col-md-3 grid1">
			  <a href="details.html">
				<img src="web/images/pic3.jpg" class="img-responsive" alt=""/>
				<div class="look">			
					<h4>Crop Levis</h4>
					<p>read more</p>
				</div></a>
			...
			<div class="col-md-3 grid1">
			  <a href="details.html">
				<img src="web/images/pic4.jpg" class="img-responsive" alt=""/>
				<div class="look">			
					<h4>get scraves</h4>
					<p>read more</p>
				</div></a>
